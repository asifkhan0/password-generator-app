...
function App() {
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg p-4 my-4 text-orange-500 bg-gray-800">
        ...
        <div className="flex text-sm gap-x-2">
          ...
          <div className="flex items-center gap-x-1">
            <input
              ...
              id="char"
            />
            <label className="cursor-pointer" htmlFor="char">
              Character
            </label>
          </div>
        </div>
